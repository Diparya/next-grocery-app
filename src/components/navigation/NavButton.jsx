import { Github, Home, Linkedin, NotebookText, Palette, Phone, Twitter, User, UserCheck } from 'lucide-react';
...
const getIcon = (icon) => {
    switch (icon) {
        case "login":
            return <UserCheck className='w-full h-auto' strokeWidth={1.5}/>
        case "signup":
